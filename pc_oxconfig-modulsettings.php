  ...
  <section class="section">
    <div class="container">
        ...
        <form name="encdec" action="pc_oxconfig-modulsettings.php" method="POST">
            ...
            <br><br>
            <h2 class="subtitle">Reset module by ID (module will be removed from aModules, aModuleEvents, aModuleFiles, aDisabledModules, aModuleVersions, aModuleTemplates)</h2>
